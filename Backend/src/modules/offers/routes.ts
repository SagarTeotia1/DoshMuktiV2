...
import { listOffersHandler, createOfferHandler, updateOfferHandler, duplicateOfferHandler, suggestedOffersHandler } from './controller';
...
export async function offersRoutes(app: FastifyInstance) {
  ...
  // Public, unauthenticated — same tier as /products, /coupon/preview.
  app.get('/offers/suggestions', suggestedOffersHandler);
}
