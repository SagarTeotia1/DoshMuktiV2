...
import { DoorOpen, ShieldCheck, Compass, Sparkles, HeartHandshake, Home, Truck, RotateCcw, Lock } from 'lucide-react';
...
const PRODUCT_SLUG = 'ghoda-ki-naal';
...
// served instantly, which was the main cause of this page feeling slow to load. There's
...
const FAQ_ITEMS = [
  {
    q: 'Is the Ghode Ki Naal really energized before shipping?',
    a: 'Yes — every Bhagya Uday Ghode Ki Naal is ritually energized following traditional Vedic practice before it leaves our workshop, the same process used across every Doshhmukti product.',
  },
  {
    q: 'Which way should I hang it?',
    a: 'The traditional practice is to hang it with the open ends facing upward, on the outside of the main entrance door, so it "catches" good fortune as it enters the home. Our AI astrologer Acharya Madhav can confirm the exact placement for your chart.',
  },
  {
  ...
  },
  {
    ...
    a: `Eligible orders of ₹${RETURN_ELIGIBLE_ABOVE} and above (this Ghode Ki Naal qualifies) come with a 7-day change-of-mind return window from delivery. Damaged or incorrect items are replaced free within 48 hours, regardless of price.`,
  },
  {
...
const BENEFIT_ICONS = [DoorOpen, ShieldCheck, Compass, Sparkles, Home, HeartHandshake];
...
// "You May Also Need" rail near the bottom — same protection/luck purpose this
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = 'Bhagya Uday Ghode Ki Naal — Luck & Protection for Your Entrance';
  const description =
    product.excerpt ||
    'A ritually energized horseshoe (Ghode Ki Naal) for your main door — an age-old tradition to ward off misfortune and invite good luck into the home.';
...
export default async function GhodaKiNaalPage() {
  ...
  const benefits =
    product.benefits.length > 0
      ...
      : [
          ...
          { title: 'Guards the Entrance', description: 'Hung above or beside the main door — the point tradition says misfortune enters from first.' },
          { title: 'An Age-Old Tradition', description: 'Invoked to ward off negative energy and invite good fortune into everyone who walks through.' },
        ];
  ...
  return (
    <div className={`${fraunces.variable} bg-[#FFFDF8] text-[#2B1B0C] overflow-x-hidden`}>
      ...
      <section className="relative bg-[#2B1B0C] overflow-hidden pt-24 sm:pt-28">
          ...
          <div className="relative z-10 aspect-square rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden shadow-[0_40px_90px_-25px_rgba(0,0,0,0.55)] sm:shadow-[0_60px_120px_-30px_rgba(0,0,0,0.55)] animate-float motion-reduce:animate-none">
            ...
            <div className="hidden sm:block absolute left-3 bottom-3 z-20 w-[4.5rem] h-[4.5rem]">
              <svg viewBox="0 0 100 100" className="w-full h-full animate-[spin_18s_linear_infinite] motion-reduce:animate-none">
                <defs>
                  <path id="gkn-badge-circle" d="M 50,50 m -38,0 a 38,38 0 1,1 76,0 a 38,38 0 1,1 -76,0" />
                </defs>
                ...
                <text fill="#E6B873" fontSize="8.2" fontWeight="700" letterSpacing="1.5">
                  <textPath href="#gkn-badge-circle" startOffset="0%">
        ...
        <div className="relative z-10 px-5 sm:px-10 mt-10 sm:mt-14">
          <div className="max-w-4xl mx-auto text-center sm:text-left">
            ...
            >
              Let good fortune <span className="italic font-light text-[#E6B873]">walk in</span> before misfortune ever can.
            </h1>
            <p className="font-body text-sm sm:text-base text-[#E6D3AE]/80 max-w-md mx-auto sm:mx-0 mt-5">
              An age-old horseshoe tradition, hung at the entrance to ward off negativity and invite luck home.
            </p>
          </div>
        </div>
      ...
      <section className="relative px-5 pt-6 sm:pt-8 pb-24 sm:pb-32 overflow-hidden">
        ...
        <Reveal className="max-w-2xl mx-auto text-center mb-14 sm:mb-16">
          ...
          <h2
            ...
            style={{ fontFamily: 'var(--font-fraunces), Georgia, serif' }}
          >
            Protection stationed <span className="italic font-light text-[#9C5A26]">right at the door.</span>
          </h2>
        </Reveal>
          ...
          <div className="max-w-3xl mx-auto flex flex-col items-center text-center gap-10">
            <Reveal>
              <h2 className="font-heading font-black text-3xl sm:text-5xl tracking-tight leading-[1.1]">
                Hung above the door.
                <br />
                Watching over everyone who enters.
              </h2>
            </Reveal>
      ...
      {/* ─── Acharya Madhav — entrance/luck-angled variant of the site-wide AI astrologer ── */}
      <AcharyaSection />
