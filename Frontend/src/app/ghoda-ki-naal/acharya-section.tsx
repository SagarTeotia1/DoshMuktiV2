...
import { MessageCircle, MoonStar, DoorOpen, Compass, ShieldAlert } from 'lucide-react';
...
// entrance direction / bhagya (fortune) instead of the generic love/wealth/health trio.
...
const ASK_ABOUT = [
  {
    icon: DoorOpen,
    label: 'Which Way Should It Face',
    prompt: 'Which way should the horseshoe face on my door?',
    question: 'Which direction should I hang the Ghode Ki Naal on my main door so it faces correctly for my home?',
  },
  {
    icon: Compass,
    label: 'Right Time to Hang It',
    prompt: 'Is now a good time to hang it, astrologically?',
    question: 'Based on my birth details, is this a good astrological period to hang a Ghode Ki Naal at my entrance?',
  },
  {
    icon: ShieldAlert,
    label: 'Blocked Luck at Home',
    prompt: 'Why does luck feel blocked at my front door?',
    question: 'Why does my luck or opportunities feel blocked lately — could my entrance direction be the reason?',
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-10 lg:gap-16 items-center">
          <Reveal className="text-center lg:text-left">
            ...
            <p className="font-body text-sm text-[#B8A98A] leading-relaxed max-w-sm mx-auto lg:mx-0 mb-8">
              Every entrance carries a different direction of fortune. Tell him your birth details and he&apos;ll
              tell you exactly how to place the Ghode Ki Naal at your door for your chart.
            </p>

            <button
              type="button"
              onClick={() => openChat('How should I hang the Ghode Ki Naal at my entrance for my chart?')}
