    ...
    <div className="animate-pulse">
      ...
      <section className="py-14 sm:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="w-52 h-6 rounded bg-[#DCC89E] mx-auto mb-10 sm:mb-14" />
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            {Array.from({ length: 4 }, (_, i) => (
              <div key={i} className="flex gap-4 rounded-xl bg-white p-5 sm:p-6">
                <div className="flex-shrink-0 w-11 h-11 rounded-full bg-[#EBD8B4]" />
                <div className="flex flex-col gap-2 flex-1">
                  <div className="w-1/2 h-3 rounded bg-[#DCC89E]" />
                  <div className="w-full h-2.5 rounded bg-[#DCC89E]" />
                  <div className="w-3/4 h-2.5 rounded bg-[#DCC89E]" />
                </div>
              </div>
            ))}
          </div>
