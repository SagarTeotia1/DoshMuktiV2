...
import { MessageCircle, MoonStar, Flame, Sparkles, ShieldAlert } from 'lucide-react';
...
// misfortune / bad-luck removal instead of the generic love/wealth/health trio.
...
const ASK_ABOUT = [
  {
    icon: Flame,
    label: 'Reading Your Run of Bad Luck',
    prompt: 'Does my chart show a run of bad luck right now?',
    question: 'Does my birth chart show a run of bad luck or misfortune right now?',
  },
  {
    icon: Sparkles,
    label: 'Right Time to Break the Streak',
    prompt: 'Is this a good period to break a streak of misfortune?',
    question: 'Is this a good astrological period to break a streak of misfortune and start fresh?',
  },
  {
    icon: ShieldAlert,
    label: 'Removing Durbhagya Dosh',
    prompt: 'How do I remove durbhagya dosh from my chart?',
    question: 'How do I remove durbhagya dosh and persistent bad luck from my birth chart?',
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-10 lg:gap-16 items-center">
          <Reveal className="text-center lg:text-left">
            ...
            <p className="font-body text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] text-[#9C5A26] mb-3">
              Not Sure This Nariyal Is Enough?
            </p>
            <h2
            ...
            <p className="font-body text-sm text-[#B8A98A] leading-relaxed max-w-sm mx-auto lg:mx-0 mb-8">
              Every chart carries a different shade of misfortune. Tell him your birth details and he&apos;ll tell
              you whether the Durbhagya Nashak Nariyal suits your chart — and what else, if anything, your dosh needs.
            </p>

            <button
              type="button"
              onClick={() => openChat('Does the Durbhagya Nashak Nariyal suit my chart for removing bad luck?')}
