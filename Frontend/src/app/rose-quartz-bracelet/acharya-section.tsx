...
import { MessageCircle, MoonStar, Heart, Sparkles, HeartHandshake } from 'lucide-react';
...
// love, relationships and the heart chakra instead of the generic love/wealth/health trio.
...
const ASK_ABOUT = [
  {
    ...
    prompt: 'What does my chart say about love right now?',
    question: 'What does my birth chart say about love and relationships right now?',
  },
  {
    icon: HeartHandshake,
    label: 'Healing a Relationship',
    prompt: 'How do I mend a strained relationship?',
    question: 'How do I mend a strained relationship or bring more harmony into it, astrologically?',
  },
  {
    icon: Sparkles,
    label: 'Opening the Heart Chakra',
    prompt: 'Is my heart chakra blocked?',
    question: 'How do I know if my heart chakra is blocked, and how do I open it?',
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-10 lg:gap-16 items-center">
          <Reveal className="text-center lg:text-left">
            ...
            <p className="font-body text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] text-[#C9863F] mb-3">
              Not Sure This Bracelet Is Right For You?
            </p>
            <h2
            ...
            <p className="font-body text-sm text-[#B8A98A] leading-relaxed max-w-sm mx-auto lg:mx-0 mb-8">
              Every chart carries a different heart. Tell him your birth details and he&apos;ll tell you
              whether the Rose Quartz Bracelet suits your chart — and what else, if anything, your heart needs.
            </p>

            <button
              type="button"
              onClick={() => openChat('Does the Rose Quartz Bracelet suit my chart for love and relationships?')}
