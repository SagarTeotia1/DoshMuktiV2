...
import { MessageCircle, MoonStar, Flame, Wind, Sparkles } from 'lucide-react';
...
// negative-energy / heaviness in the home instead of the generic love/wealth/health trio.
...
const ASK_ABOUT = [
  {
    icon: Wind,
    label: 'Heaviness In the Home',
    prompt: 'Why does my home feel heavy or stuck lately?',
    question: 'My home has been feeling heavy, tense or stuck lately — could there be negative energy that needs clearing?',
  },
  {
    icon: Flame,
    label: 'Best Days for Havan',
    prompt: 'Which days are best for me to do a havan?',
    question: 'Based on my birth details, which days or muhurat are best for me to perform a havan or fire-purification ritual?',
  },
  {
    icon: Sparkles,
    label: 'Clearing Vastu Dosh',
    prompt: 'How do I clear vastu dosh with a havan?',
    question: 'How can a havan or hawan ritual help clear vastu dosh or negative energy building up in my home?',
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-10 lg:gap-16 items-center">
          <Reveal className="text-center lg:text-left">
            ...
            <p className="font-body text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] text-[#C9863F] mb-3">
              Not Sure How Often to Do Havan?
            </p>
            <h2
            ...
            <p className="font-body text-sm text-[#B8A98A] leading-relaxed max-w-sm mx-auto lg:mx-0 mb-8">
              Every home carries a different weight of negative energy. Tell him your birth details and he&apos;ll
              tell you how often to burn the Divya Hawan Powder — and which mantra to pair it with for your chart.
            </p>

            <button
              type="button"
              onClick={() => openChat('How often should I burn the Divya Hawan Powder for my home, based on my chart?')}
