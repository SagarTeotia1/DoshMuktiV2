...
import { ShieldCheck, ShieldAlert, Sparkles, Compass, Flame, HeartHandshake, Truck, RotateCcw, Lock } from 'lucide-react';
...
const PRODUCT_SLUG = 'durghatna-nashak-yantra';
...
// served instantly for 60s, which was the main cause of this page feeling slow to load.
...
const FAQ_ITEMS = [
  {
    q: 'Is the Yantra really energized before shipping?',
    a: 'Yes — every Durghatna Nashak Yantra is ritually energized following traditional Vedic practice before it leaves our workshop, the same process used across every Doshhmukti product.',
  },
  {
  ...
  },
  {
    ...
    a: `Eligible orders of ₹${RETURN_ELIGIBLE_ABOVE} and above (this Yantra qualifies) come with a 7-day change-of-mind return window from delivery. Damaged or incorrect items are replaced free within 48 hours, regardless of price.`,
  },
  {
  ...
  },
  {
    ...
    a: 'Most customers keep it in their wallet, workspace, home altar or vehicle — it travels with you, not a specific room or seat.',
  },
];
...
const BENEFIT_ICONS = [ShieldCheck, ShieldAlert, Compass, Flame, Sparkles, HeartHandshake];
          ...
          <div className="relative z-10 aspect-square rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden shadow-[0_40px_90px_-25px_rgba(0,0,0,0.55)] sm:shadow-[0_60px_120px_-30px_rgba(0,0,0,0.55)] animate-float motion-reduce:animate-none">
            ...
            <div className="hidden sm:block absolute left-3 bottom-3 z-20 w-[4.5rem] h-[4.5rem]">
              <svg viewBox="0 0 100 100" className="w-full h-full animate-[spin_18s_linear_infinite] motion-reduce:animate-none">
                <defs>
                  <path id="dny-badge-circle" d="M 50,50 m -38,0 a 38,38 0 1,1 76,0 a 38,38 0 1,1 -76,0" />
                </defs>
                ...
                <text fill="#E6B873" fontSize="8.2" fontWeight="700" letterSpacing="1.5">
                  <textPath href="#dny-badge-circle" startOffset="0%">
      ...
      <section className="relative px-5 pt-6 sm:pt-8 pb-24 sm:pb-32 overflow-hidden">
        ...
        <Reveal className="max-w-2xl mx-auto text-center mb-14 sm:mb-16">
          ...
          <h2
            ...
            style={{ fontFamily: 'var(--font-fraunces), Georgia, serif' }}
          >
            Protection built into <span className="italic font-light text-[#9C5A26]">every day.</span>
          </h2>
        </Reveal>
