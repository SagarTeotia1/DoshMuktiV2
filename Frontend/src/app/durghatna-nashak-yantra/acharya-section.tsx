...
import { MessageCircle, MoonStar, ShieldAlert, Compass, AlertTriangle } from 'lucide-react';
...
// accident risk / misfortune dosh instead of the generic love/wealth/health trio.
...
const ASK_ABOUT = [
  {
    icon: AlertTriangle,
    label: 'Accident Risk Right Now',
    prompt: 'Does my chart show risk of accidents right now?',
    question: 'Does my birth chart show any risk of accidents or sudden mishaps right now?',
  },
  {
    icon: Compass,
    label: 'Safe to Start Something New',
    prompt: 'Is this a good period to start something new safely?',
    question: 'Is this a good astrological period for me to start something new safely, without inviting misfortune?',
  },
  {
    icon: ShieldAlert,
    label: 'Removing Rahu-Ketu Dosh',
    prompt: 'How do I protect against Rahu-Ketu / accident dosh?',
    question: 'How do I protect myself against Rahu-Ketu related dosh or accident-prone periods in my chart?',
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-10 lg:gap-16 items-center">
          <Reveal className="text-center lg:text-left">
            ...
            <p className="font-body text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] text-[#9C5A26] mb-3">
              Not Sure This Yantra Is Enough?
            </p>
            <h2
            ...
            <p className="font-body text-sm text-[#B8A98A] leading-relaxed max-w-sm mx-auto lg:mx-0 mb-8">
              Every chart carries a different risk of accidents and misfortune. Tell him your birth details and
              he&apos;ll tell you whether the Durghatna Nashak Yantra suits your chart — and what else, if anything,
              your period needs.
            </p>

            <button
              type="button"
              onClick={() => openChat('Does the Durghatna Nashak Yantra suit my chart for accident protection?')}
